    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl font-light text-gray-600 dark:text-white">
            {t("imprint.subtitle")}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-8 space-y-8">
          <div>
            ...
            <div className="text-gray-700 font-light dark:text-white space-y-2">
          ...
          <div className="border-t pt-8">
            ...
            <p className="text-gray-700 font-light dark:text-white leading-relaxed">
