...
const projectImages = {
  project1: [
    "/room/problem_nische_berliner_zimmer.webp",
    "/room/entwurf_nische_bett.webp",
    "/room/room1/nische_berliner-zimmer_hochbett_stauraum.webp",
  ],
  project2: [
    "/furniture/quadra/moebelbau_akazien_sideboard_schrank.webp",
    "/furniture/quadra/massgeschneiderte_moebel_detail_altbau.webp",
    "/furniture/quadra/sideboard_hochwertig_altbau_mid-century.webp",
  ],
  project3: [
    "/room/room2/wgzimmer_berlin_kleiderschrank.webp",
    "/room/room2/wgzimmer_entwurf_altbauwohnung_raumkonzept.webp",
    "/room/room2/raumteiler_homeoffice_studio_kleine_wohnung_raumkonzept.webp",
  ],
  project4: [
    "/room/room4/zimmer_unordnung_schraenke_stauraum.webp",
    "/room/room4/studio_designloesung_raumbildend_einbauschrank.webp",
    "/room/room4/einbauschrank_stauraum_bettschrank_kleine_wohnung_berlin.webp",
  ],
  project5: [
    "/room/room13/gaestezimmer_stauraum_vorher_2.webp",
    "/room/room13/gaestezimmer_stauraum_nachher_2.webp",
    "/room/room13/kleines_arbeitszimmer_vorher_1.webp",
    "/room/room13/kleines_arbeitszimmer_nachher_1.webp",
  ],
  project6: [
    "/room/room11/studio_bett_stauraumproblem_kleine_wohnung.webp",
    "/room/room11/kleine-wohnung_design_entwurf_podestbett.webp",
    "/room/room11/podestbett_arbeitsplatz_altbauwohnung_studio_stauraum.webp",
    "/room/room11/wgzimmer_dunkel_schreibtisch_wohnbereich.webp",
    "/room/room11/zimmer_design_podestbett.webp",
